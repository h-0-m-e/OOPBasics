...
fun main() {
    ...
    WallService.add(Post(5,23,12,22,20212109,false,"Nothing to read here", views = 0, likes = 0))
    WallService.printAll()
    val newPost = Post(1,9923,9923,9923,20222610,false,"NEW Text Sample",views = 0, likes = 0)
